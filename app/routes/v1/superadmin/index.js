...
const {allocationRole : allocationRoleValidator, getUserRoles : getUserRolesValidator} = require('../../../http/validator/su/roleAllocation');
...
router.get('/userRoles/:id',getUserRolesValidator(), validation,showUserRoles);
